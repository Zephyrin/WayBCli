...
import { SubCategoryUpdateComponent } from './sub-category-update/sub-category-update.component';
...
export class SubCategoryComponent implements OnInit, OnDestroy {
  ...
  canEditOrDelete(subCategory: SubCategory) {
    return !subCategory.validate;
  }

  updateAskValidate(subCategory: SubCategory) {
     this.errors = new FormErrors();
     this.setSelected(subCategory);
     this.loading = true;
     subCategory.askValidate = !subCategory.askValidate;
